...
# Stage 5. Train without augmentations. ===================================================================================================

#python src/train.py experiment=train_seat_seg +model.net.model_name=segmentation_models_pytorch/UnetPlusPlus  +model.net.encoder_name=mobilenet_v2 model.optimizer.lr=0.00045 data.batch_size=8 trainer.max_epochs=50 logger=many_loggers data.data_dir="/media/gpu0/data/lukas/DeepVisionXplain/data/lear_outline_synth"