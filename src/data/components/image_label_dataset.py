...
class ImageLabelDataset(Dataset):
    ...
    def _get_img_label_pairs(self):
        ...
        for img_path in img_files:
            ...
            label_path = label_path.with_name(label_path.stem + '_mask' + label_path.suffix)
    ...
    def __getitem__(self, idx):
        ...
        label = Image.open(label_path).convert("L")  # Adjust if your labels are in a different format
